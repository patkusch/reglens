...
| 0:45–1:15 | Terminal: `python -m reglens.agent.mcp_client` (tool list), then run the agent | "RegLens reads that graph through DataHub's MCP server and finds the blast radius automatically — 10 assets, including the risk-scoring model." |
